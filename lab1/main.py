...
def main():
    ...
    print("Деление")
    number_3 = int(input("Введите положительное число"))
    print(f"Число введено: {number_3}")
    print(f"Беззнаковый код: {convert_to_unmarked_code(number_3)}")
    number_4 = int(input("Введите положительное число"))
    print(f"Число введено: {number_4}")
    print(f"Беззнаковый код: {convert_to_unmarked_code(number_4)}")
    result_dividing = divide_binary_code(convert_to_unmarked_code(number_3), convert_to_unmarked_code(number_4))
    print(f"Результат деления: {result_dividing} ")
    print(f"Из фиксированной точки в число, {convert_from_fixed_point_to_10(result_dividing)}" )
